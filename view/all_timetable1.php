...
$sql="select subject.name as s_name,teacher.i_name as t_name,class_room.name as c_name
	  ...
	  where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.day='Sunday'";
...
$sql="select subject.name as s_name,teacher.i_name as t_name,class_room.name as c_name
	  ...
	  inner join class_room
	  on timetable.classroom_id=class_room.id
	  where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.day='Monday'";
...
$sql="select subject.name as s_name,teacher.i_name as t_name,class_room.name as c_name
	  ...
	  inner join class_room
	  on timetable.classroom_id=class_room.id
	  where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.day='Tuesday'";
...
$sql="select subject.name as s_name,teacher.i_name as t_name,class_room.name as c_name
	  ...
	  inner join class_room
	  on timetable.classroom_id=class_room.id
	  where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.day='Wednesday'";
...
$sql="select subject.name as s_name,teacher.i_name as t_name,class_room.name as c_name
	  ...
	  inner join class_room
	  on timetable.classroom_id=class_room.id
	  where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.day='Thursday'";
...
$sql="select subject.name as s_name,teacher.i_name as t_name,class_room.name as c_name
	  ...
	  inner join class_room
	  on timetable.classroom_id=class_room.id
	  where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.day='Friday'";
...
$sql="select subject.name as s_name,teacher.i_name as t_name,class_room.name as c_name
	  ...
	  inner join class_room
	  on timetable.classroom_id=class_room.id
	  where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.day='Saturday'";
