  	...
  	<div class="modal fade" id="loginFrom" tabindex="-1" role="dialog" aria-labelledby="loginFrom" aria-hidden="true">
    	<div class="modal-dialog" style="margin-top: 200px;">    
        	<div class="modal-content" style="border-radius: 25px;"> 
        		<div class="modal-header bg-blue-gradient" id="radius">
          			<h4 style="text-align: center;">Booster Login</h4>
        		</div>
        		<div class="modal-body bgColorWhite">
        			<form role="form" action="../index.php" method="post">                    
                  		...
                  		<div class="box-footer">
                    		...
                    		<button type="submit" class="btn btn-info bg-blue-gradient" id="btnSubmit">Submit</button>
                  		</div>
                	</form>
        		</div>
      		</div>      
